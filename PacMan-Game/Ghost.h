...
public:
	...
	Direction::eDirection GetMovement(GameBoard board , int ghostInd, const Position& destination,const Position& source, PositionsVector ghostsPositions) { return m_Movement->GetMove(board, ghostInd, destination, source, ghostsPositions); };
};